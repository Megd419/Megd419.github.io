...
window.addEventListener("load", function(e){
    ...
    submitInput.addEventListener("click", function(e){
        ...
        document.querySelector("#fn-error").innerHTML = res;

        if (res === false)
        {
            alert("Your name must not include numbers or special characters");
        }
        ...
        document.querySelector("#ln-error").innerHTML = res;
